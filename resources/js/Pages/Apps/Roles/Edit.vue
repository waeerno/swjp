                        ...
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            ...
                            <div class="card-body">
                                <form @submit.prevent="submit">
                                    <div class="mb-3">
                                        <label class="fw-bold">Role
                                            Name</label>
                                        <input class="form-control" v-model="form.name"
                                            :class="{ 'is-invalid': errors.name }" type="text" placeholder="Role Name">
...
export default {
    ...
    setup(props) {
        ...
        const form = reactive({
            ...
            permissions: props.role.permissions.map(obj =>
                obj.name),
        });
        //method "submit"
        const submit = () => {
